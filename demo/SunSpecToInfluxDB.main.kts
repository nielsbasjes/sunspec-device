...
@file:DependsOn("nl.basjes.sunspec:sunspec-device:0.2.2-SNAPSHOT")
@file:DependsOn("nl.basjes.modbus:modbus-api-plc4j:0.5.0")
@file:DependsOn("com.influxdb:influxdb-client-java:7.2.0")
@file:DependsOn("args4j:args4j:2.37")
@file:DependsOn("org.apache.logging.log4j:log4j-slf4j2-impl:2.24.3")
